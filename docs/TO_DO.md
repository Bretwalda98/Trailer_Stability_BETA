...
## TS-002 — Large scaled search-case matrix — Recommended: GPT-5.6 Sol High
...
## TS-010 — Complete engineering result panels — Recommended: GPT-5.6 Sol High
...
## TS-009 — Readable activity log and diagnostic audit output — Recommended: GPT-5.6 Sol High
...
## TS-004 — Pareto comparison view — Recommended: GPT-5.6 Sol High
...
## TS-008 — User-editable optimiser objective order — Recommended: GPT-5.6 Sol High
...
## TS-007 — Dependency and security review — Recommended: GPT-5.6 Sol High
