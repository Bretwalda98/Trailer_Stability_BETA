...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    intro: "Project JSON keeps the complete case portable. The AutoCAD export is a coded, versioned JSON interchange with a separate decoding key.",
    steps: [
      "Use Open case or Import project JSON to resume a saved calculation-ready case.",
      "Export to AutoCAD downloads a coded JSON payload containing resolved trailer geometry, axle points, hydraulic groups, supports, catalogue values, the authoritative result and engineering methods.",
      "The companion key file maps every short field code to its meaning, unit and coordinate convention. Readers should ignore unknown fields so future versions remain compatible.",
